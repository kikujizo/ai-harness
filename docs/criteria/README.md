...
- [capability-classification-criteria.md](capability-classification-criteria.md) — capability 種別・差別化・domain vision を扱う設計成果物向けのバイナリ基準（5項目）。technical capability への根拠なき事業価値付与を検出する。設計・アーキテクチャ文書のレビューでは `recursive-review` 手順1（文書レビュー）で本ファイルを選択する（[`.agents/skills/recursive-review/SKILL.md`](../../.agents/skills/recursive-review/SKILL.md) L17–21 参照）。
